...
> **กำลังพัฒนา** หลักสูตรนี้อิงเฟิร์มแวร์ BENTO สำหรับ Edge AI ที่ยังพัฒนาอยู่ ชื่อฟังก์ชัน โมเดล และขั้นตอนบนบอร์ดอาจเปลี่ยนก่อนออกรุ่นจริง
> เรียนและทดลองใน BENTO Emulator ได้ ถ้าเจอจุดที่ไม่ตรงกับที่เห็น แจ้งได้ที่ [GitHub Issues](https://github.com/tesaiot/tesa-qualification-program/issues)
