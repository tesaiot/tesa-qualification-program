# Edge AI & IoT for Product Decisions

Level **L1 Aware** · status **alpha** · 6 lessons of about 30 minutes · about 3 hours in total · **no code, no board**

A course for business owners, executives and product owners who must decide whether and how to invest in edge AI and IoT.
It does not teach programming. It teaches you to ask the right questions: separate the problems this technology really
helps with from the ones it should not be used for, see the full cost and risk before budgeting, and write a brief a
...
**Module 1 — Understand the options** ([m01-understand-the-options](m01-understand-the-options/README.md))
...
**Module 2 — Decide and brief** ([m02-decide-and-brief](m02-decide-and-brief/README.md))
