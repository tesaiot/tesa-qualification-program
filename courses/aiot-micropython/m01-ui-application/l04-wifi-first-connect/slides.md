...
เปิด [`01_wifi_first_connect.py`](https://github.com/tesaiot/tesa-qualification-program/blob/main/courses/aiot-micropython/m01-ui-application/l04-wifi-first-connect/examples/01_wifi_first_connect.py) แก้สองบรรทัดบนสุดให้ตรงกับเครือข่ายที่ผู้สอนแจกหน้าห้อง แล้วส่งขึ้นบอร์ดเลย
