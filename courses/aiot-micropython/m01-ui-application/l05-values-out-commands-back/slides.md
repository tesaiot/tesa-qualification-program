...
<svg viewBox="0 0 940 230" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="270" y="192" font-size="17" fill="#8d4a4a">ไม่มีสายออกนอกเบราว์เซอร์ ต่อ "ติด" เสมอแต่ไม่มีอะไรไปถึง hivemq</text>
  <text x="270" y="216" font-size="17" fill="#8d4a4a">คนที่ใช้ Emulator อย่างเดียว ดูบอร์ดจริงของทีมผ่านหน้าเว็บแทน</text>
</svg>
