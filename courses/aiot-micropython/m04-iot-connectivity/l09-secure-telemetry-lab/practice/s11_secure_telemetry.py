...
# --- ก่อนท่าที่ 2: กางหน้าจอ แล้วเอาตัวตนที่ตั้งไว้ขึ้นให้เห็น (เขียนมาให้แล้ว) ---
...
while tesaiot.is_connected():
    ...
    # การเช็ก is_connected() ก่อนส่ง "ทุกครั้ง" อยู่ที่หัวลูป while ข้างบนแล้ว (m04-iot-connectivity/l08-tesaiot-module/examples/06_secure_publish_loop.py
    #   เช็กที่ต้นทุกรอบแบบเดียวกัน) เพราะสายหลุดกลางทางได้ ไม่ใช่เช็กแค่ครั้งเดียวตอนเริ่ม
