...
<svg viewBox="0 0 940 268" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="36" y="86" font-size="18" fill="#c9d3e8">my-hotspot</text>
...
![หน้าจอจาก BENTO Emulator ของเฉลยหน้าสถานะเครือข่าย w:470](img/emu/s09.png)

<div style="font-size:.56em;color:#78909c;margin-top:-.3em">หน้าจอจากการรันโค้ดเฉลยบน BENTO Emulator ที่ 800x480 เท่าจอของทั้งสองบอร์ด — ไม่ใช่ภาพวาดและไม่ใช่ mock-up · โค้ดคือ <code>s09_network_status.py</code> ของบทเรียน 4.3</div>
