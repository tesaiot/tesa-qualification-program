...
#             ตัวแรกทำลาย ตัวหลังย้อนกลับ - เลือกผิดตัวคือเสียตัวตนของอุปกรณ์ไปทั้งชุด
...
# ตัวตนของอุปกรณ์ - แก้สี่ค่านี้เป็นค่าจากหน้าจัดการอุปกรณ์ในบัญชี TESAIoT Platform ของคุณก่อนรัน (config_reset() ล้าง mqtt_pass ด้วย จึงต้องตั้งคืนเหมือนกัน)
DEVICE_ID = "team03"
