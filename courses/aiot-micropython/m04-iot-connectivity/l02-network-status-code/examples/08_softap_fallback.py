# 08_softap_fallback.py - ถ้าหาวงที่ตั้งไว้ไม่เจอ บอร์ดปล่อยวงของตัวเองได้
#
...
#
# Why : วันที่ 14 ส.ค. 2026 ผู้เขียนสแกนจากบอร์ดในห้องจริงแล้วเจอ 18 วง
#        แต่ไม่มีวงที่ตัวอย่างตั้งไว้อยู่ในนั้นสักวง ไฟล์ที่เรียก connect() ตรง ๆ
...
#
# ดูที่จอ: แถวล่างคือวงที่สแกนเจอจริง ๆ รอบตัว แถวบนบอกว่าบอร์ดตัดสินใจทำอะไร
# กับดัก : softap() ไม่ใส่อาร์กิวเมนต์จะได้ชื่อ PSoC-Edge-MPY รหัส micropython
#          บอร์ดทุกตัวที่ไม่ตั้งชื่อจะชื่อซ้ำกันหมด ตั้งชื่อของตัวเองเสมอ
...
# ตั้งชื่อวงสำรองให้ไม่ซ้ำกับวงอื่นรอบตัว เช่นเปลี่ยน team01 เป็นชื่อเล่นภาษาอังกฤษของคุณ
...
if target is not None:
    ...
    # softap() รับสองอาร์กิวเมนต์ ไม่ใส่ก็ได้แต่จะได้ชื่อซ้ำกับบอร์ดทุกตัวที่ไม่ได้ตั้ง
