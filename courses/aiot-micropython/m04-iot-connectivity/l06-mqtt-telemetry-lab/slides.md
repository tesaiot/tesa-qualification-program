...
<svg viewBox="0 0 940 164" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="122" y="52" text-anchor="middle" font-size="20" font-weight="700" fill="#1565c0">1 · ฟังทุกอุปกรณ์</text>
  <text x="122" y="88" text-anchor="middle" font-size="18" fill="#0d47a1">device/+/telemetry</text>
  <text x="122" y="122" text-anchor="middle" font-size="18" fill="#5472a3">แล้วเทียบ schema กัน</text>
...
> ทุกตัวเลขบนสไลด์นี้สืบกลับไปที่ซอร์สโค้ดหรือเอกสารต้นทางได้ ถ้าเจอที่ไม่ตรง [แจ้ง erratum](https://github.com/tesaiot/tesa-qualification-program/issues/new?template=erratum.yml) ได้เลย
