...
# ก่อนจะแก้ TOPIC_PUB กับ TOPIC_CMD ข้างล่างให้เป็นของคุณ อ่านสองไฟล์นั้นก่อน
#
...
DEVICE_ID = "team03"                # ต้องตรงกับ device_id ที่ขึ้นทะเบียนบนแพลตฟอร์ม             # <= 31 ตัวอักษร และต้องไม่ซ้ำกับอุปกรณ์อื่นใน CE เดียวกัน
