...
while True:
    ...
    # หน่วง 50 ms ตามกฎข้อ 2 (เร็วกว่านี้เฟรมหาย) แต่อย่าหลับยาวเป็นร้อย ๆ ms เพราะระหว่างหลับ
    # ไม่มีใครเรียก ui.poll() คิวเหตุการณ์ 15 ช่องเต็มแล้วการแตะใหม่หายเงียบ ๆ ดูเหมือนจอค้าง
    time.sleep_ms(50)
