...
## ปลายทางของชุดบทเรียนนี้ — แผงคุมไฟวิ่งที่คุยกับบอร์ดรู้เรื่อง

![หน้าจอจาก BENTO Emulator ของเฉลยไฟวิ่งกับปุ่ม พร้อมตัวนับการกด w:540](img/emu/s03.png)

<div style="font-size:.58em;color:#78909c;margin-top:-.3em">หน้าจอจริงจากการรันโค้ดเฉลยบน BENTO Emulator ที่ 800x480 เท่าจอของทั้งสองบอร์ด — ไม่ใช่ภาพวาด ไม่ใช่ mock-up และไม่ใช่ภาพถ่ายจากบอร์ด · โค้ดคือ <code>s03_led_button.py</code> ของบทเรียน 2.3</div>

- **บนซ้าย** ไฟบนบอร์ดตามจำนวนที่ถามบอร์ดเอาเอง: Eva Kit ตอบ 3 ดวง · Dev Kit ตอบ 5 ดวง ดวงที่สว่างบนจอคือดวงที่โค้ดสั่ง — จอสะท้อนคำสั่ง ไม่ใช่ค่าที่ขาอ่านกลับมา
- **บนขวา** ปุ่มกับตัวนับการกด — ชื่อ `USER Button 1` คือชื่อที่เฟิร์มแวร์ตอบ **ไม่ใช่**ป้ายที่พิมพ์บนแผ่นวงจร และบอร์ดสองรุ่นพิมพ์ต่างกัน (สไลด์ "กับดักชื่อ" เล่าว่าทำไม)
- **ล่าง** ปุ่มสัมผัส "เดินไฟวิ่ง" กับ "หยุดไฟวิ่ง" และเวลาที่เหลือของรอบ 30 วินาที

> ผลลัพธ์จริงอยู่ที่ **LED บนตัวบอร์ด** ที่ไล่ดวงอยู่ จอบอกแค่ว่าโค้ดสั่งอะไร และนับการกดได้กี่ครั้ง
