...
| **How** | ประกอบยังไงให้ใช้งานได้จริง | event loop ที่เรียก `ui.poll()` ทุกรอบ แยกว่าเหตุการณ์มาจากใครด้วย `handle` แล้วสั่ง `gpio.led()` พร้อมเขียนบรรทัดสถานะกลับในจังหวะเดียวกัน | แปดไฟล์ตัวอย่าง + ไฟล์ฝึก |
