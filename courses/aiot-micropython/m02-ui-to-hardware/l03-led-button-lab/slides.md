...
2. บรรทัดสถานะบนหน้าเว็บต้องขึ้น "ต่อแล้ว (bento-aiot/team05)" ตามเลขทีมของคุณ
...
<div style="font-size:.56em;color:#90a4ae"><b>01</b> ถามบอร์ดก่อนว่ามีอะไรให้เล่นบ้าง · <b>02</b> ทำให้ไฟกะพริบเป็นจังหวะ แล้วนับรอบที่กะพริบไปแล้ว · <b>03</b> หรี่ไฟค้างไว้ให้นานพอที่ตาจะเทียบสองระดับได้ · <b>ภาพชุดนี้เก่า</b> ถ่ายก่อนไฟล์ 01-03 ถูกเขียนใหม่ (14 ส.ค.) — เช่น ภาพ 03 ยังเทียบ 10 กับ 90 ส่วนไฟล์วันนี้ให้มองหลอดตอน <code>brightness(40)</code> ก่อน รอถ่ายใหม่</div>
...
<div style="font-size:.56em;color:#90a4ae">**04** ปุ่มนี้ 0 คือกด ไม่ใช่ 1 · **05** นับการกดให้ตรง ด้วยการรอให้ปุ่มนิ่งก่อน · **06** ปุ่มเดียวคุมไฟทุกดวง ด้วยการจำสถานะเอง · **ภาพชุดนี้เก่า** ถ่ายตอนไฟล์ 04/06 ยังเรียกปุ่มว่า "BTN0" — ปัจจุบันไฟล์พิมพ์ชื่อจาก `btn.name()` (= "USER Button 1") รอถ่ายใหม่</div>
