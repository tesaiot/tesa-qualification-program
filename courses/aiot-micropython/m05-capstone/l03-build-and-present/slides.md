...
<svg viewBox="0 0 940 220" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="470" y="176" text-anchor="middle" font-size="19" font-weight="700" fill="#c62828">ห้ามข้ามขั้นตั้งเกณฑ์ — ทีมที่ตั้งจากการเดาแล้วไม่เคยทดสอบ จะไปเจอตอนนำเสนอว่ามันไม่เตือน</text>
...
> ทุกข้อจำกัดข้างบนมี path และเลขบรรทัดกำกับ ไม่ได้มาจากเอกสารฉบับใด ถ้าเจอที่ไม่ตรงกับบอร์ด [แจ้ง erratum](https://github.com/tesaiot/tesa-qualification-program/issues/new?template=erratum.yml) ได้เลย
