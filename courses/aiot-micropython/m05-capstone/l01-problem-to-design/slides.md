...
![หน้าจอจาก BENTO Emulator ของโครงตั้งต้น capstone w:540](img/emu/s12.png)

<div style="font-size:.58em;color:#78909c;margin-top:-.3em">หน้าจอจากการรันโค้ดเฉลยบน BENTO Emulator ที่ 800x480 เท่าจอของทั้งสองบอร์ด — ไม่ใช่ภาพวาดและไม่ใช่ mock-up · โค้ดคือ <code>s12_capstone_starter.py</code> ของบทเรียน 5.3</div>
