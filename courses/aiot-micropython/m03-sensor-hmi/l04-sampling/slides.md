...
| **What** | มีอะไรให้ใช้บ้าง | `ui.Chart` กับเมธอดของ `Widget` **ทั้ง 14 ตัว** — สองตัวเป็นของกราฟล้วน ๆ · บวกตัวสร้าง widget ของ `ui` ทั้ง **16 ตัว** ที่กางครบในตารางอ้างอิงของชุดบทเรียนนี้ | สไลด์บัญชี 14 เมธอด + ตารางอ้างอิง widget |
