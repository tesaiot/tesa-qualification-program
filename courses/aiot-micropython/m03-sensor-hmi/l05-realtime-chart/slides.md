...
| `.value()` / `.value(n)` | อ่าน / สั่งค่า มีหกชนิดเท่านั้นที่ตอบได้จริง | ไม่ใช้ในชุดบทเรียนนี้ · `Chart` ไม่ใช่หนึ่งในหกชนิดนั้น |
...
**และฝั่งตัวสร้างมีสิบหกตัว** ตารางอ้างอิงข้างบนกางไว้สิบชนิด อีกหกตัวที่เหลือคือของที่เราใช้มาตั้งแต่บทเรียน 1.1–3.3 อยู่แล้ว: `Label` `Button` `Switch` `Slider` `Checkbox` `Bar` — บัญชีเต็มของทั้งโมดูล `ui` อยู่ในบทเรียน 2.4–2.6
