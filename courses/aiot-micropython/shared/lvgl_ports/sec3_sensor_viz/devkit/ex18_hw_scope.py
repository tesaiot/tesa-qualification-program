...
# ==== BOARD: TESAIoT Dev Kit — pot = VR1 (pots ตรงสกรีน), LED น้ำเงิน P20.5 ====
import pots
import gpio


def pot_pct():
    r = pots.read(0)                     # VR1: 0-4095
    return (r * 100) // 4095, r


hw_led = gpio.led(3)  # RGB น้ำเงิน P20.5 - มี PWM route จริง (R2 2026-08-20)
POT_NAME = "VR1"
# ==== END BOARD ====
