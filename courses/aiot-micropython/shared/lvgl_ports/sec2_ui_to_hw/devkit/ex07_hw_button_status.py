...
# ==== BOARD: TESAIoT Dev Kit — สามปุ่มจริง: USER Button 1 (บนบอร์ด AI Kit) +
# SW4/SW5 สองปุ่มพิเศษบนฐาน (P17.5/P17.7 pull-up ภายใน — กลไกเดียวกับเมนู
# GPIO & RGB ของ firmware ที่อ่านคู่นี้ได้อยู่แล้ว) ====
import buttons

_b1 = gpio.button(0)
BTNS = (
    ("USER Button 1", _b1.is_pressed, 0x00BCD4),
    ("SW4", lambda: buttons.pressed(0), 0xFF9800),
    ("SW5", lambda: buttons.pressed(1), 0x4CAF50),
)
# ==== END BOARD ====
