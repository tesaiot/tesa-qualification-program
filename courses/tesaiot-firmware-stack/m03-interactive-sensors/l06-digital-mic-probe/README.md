...
หรือเปิด [ตัวอย่างนี้บน Developer Hub](https://dev.tesaiot.dev/?q=int_ep06_digital_mic_probe) แล้ว flash เฟิร์มแวร์สำเร็จรูป
...
- [ค้นหาตัวอย่างนี้บน Developer Hub](https://dev.tesaiot.dev/?q=int_ep06_digital_mic_probe)
