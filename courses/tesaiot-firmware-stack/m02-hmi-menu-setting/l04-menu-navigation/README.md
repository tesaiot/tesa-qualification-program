...
หรือเปิด [ตัวอย่างนี้บน Developer Hub](https://dev.tesaiot.dev/?q=hmi_ep04_menu_navigation) แล้ว flash เฟิร์มแวร์สำเร็จรูป
...
- [ค้นหาตัวอย่างนี้บน Developer Hub](https://dev.tesaiot.dev/?q=hmi_ep04_menu_navigation)
