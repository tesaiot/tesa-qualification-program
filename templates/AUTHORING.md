...
วิดีโอไม่ได้ฝังไว้ใน README แต่ลงทะเบียนไว้ที่เดียวใน [catalog/videos.yaml](../catalog/videos.yaml) แล้วเว็บจะแสดงกล่อง
"วิดีโอประกอบ" ให้เองทั้งหน้าไทยและหน้าอังกฤษ บนหน้าบทเรียนกล่องนี้อยู่ด้านบน บนหน้าหลักสูตรจะรวมวิดีโอของทุกบทเรียนไว้ท้ายหน้า

- เพิ่มรายการใน `videos:` ประกอบด้วย `id` (11 ตัวอักษรจาก URL ของ YouTube), `title` ตามที่เผยแพร่จริง, `channel`
  (ต้องมีใน `channels:`) และ `lessons` เป็นรายการ id ของบทเรียนที่วิดีโอนี้ประกอบ
- ช่องใหม่ต้องมีชื่อสองภาษา ถ้าเป็นผลงานของบุคคล ให้ใส่ `credit` เป็นเครดิตเต็มพร้อมสังกัด (ดู [ATTRIBUTION.md](../ATTRIBUTION.md))
